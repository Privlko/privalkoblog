...
I propose looking at this data here.


Discussions of Russia's inequality overwhelmingly focus on the Ultra-rich. 
...
This post explores how incomes and income inequality have evolved in Russia between 1991 and 2020. 
...
For each measure, I will also look at patterns of growth across the distribution and the implications of these patterns for income inequality. 
...
ru2 %>%  
  ...
  geom_rect(data=rect3, aes(xmin=xmin, xmax=xmax, ymin=ymin, ymax=ymax),
            ...
            alpha=0.1,
            inherit.aes = FALSE) +
  labs(title="Year-on-year growth in real (adjusted for CPI) earnings and wages (1995-2020)",
       subtitle = "Growth in income and wages has slowed. Conflict, sanctions, and recessions are roughly highlighted in grey. \nIncome growth is lowest in these periods.",
       x='Year',
