...
Instead, we will consider two measures of inequality statistics within years; the p90:p10 ratio and the top decile's share of total income for each year.  
...
We also want to consider how these figures looked in 2012, when Russia had just began to recover from its financial crisis, partially caused by the wider European Debt Crisis. 
...
For example, for the 3rd percentile, income grew almost 25 times greater between 2000 and 2007; for the 97th percentile income grew almost 10 times greater during the same period. 
...
However, despite this, the top decile also has the largest share of total Russian income. 
